        ...
        set((state) => {
          ...
          switch (profileType) {
            case 'PROFILE_CAUSAL':
              ...
              prof.skillDetails.causeEffect = { score: 0.28, confidence: 0.2, recentEvidence: [false, false, true, false, false], trend: 'declining' };
              ...
              prof.behavioralLog.documentsOpened = ['emergency_log_alpha', 'witness_report_bravo'];
              prof.behavioralLog.readingOrder = ['emergency_log_alpha', 'witness_report_bravo', 'emergency_log_alpha'];
              prof.behavioralLog.actionsAttempted = ['ACTIVATE:pump_b', 'ACTIVATE:valve_a', 'ACTIVATE:pump_b'];
              prof.behavioralLog.earlyCommitments = 2;
              prof.behavioralLog.luckyAnswerCounts.correct_answer_weak_evidence = 2;
              prof.behavioralLog.luckyAnswerCounts.wrong_answer_irrelevant_reasoning = 1;
              prof.experienceMemory.worldsExperienced = ['lost_observatory', 'arctic_station'];
              prof.experienceMemory.archetypesExperienced = ['MECHANISM', 'INVESTIGATION'];
              break;
            case 'PROFILE_SEQUENCE':
              prof.skills.sequencing = 0.25;
              prof.skills.causeEffect = 0.72;
              prof.skillConfidence.sequencing = 0.2;
              prof.skillDetails.sequencing = { score: 0.25, confidence: 0.2, recentEvidence: [false, true, false, false, false], trend: 'declining' };
              ...
              prof.behavioralLog.recoveriesAfterFailure = 1;
              prof.experienceMemory.worldsExperienced = ['lost_observatory'];
              prof.experienceMemory.archetypesExperienced = ['TIMELINE'];
              break;
            case 'PROFILE_NEGATION':
              prof.skills.negativeConstraint = 0.22;
              prof.skillConfidence.negativeConstraint = 0.2;
              prof.skillDetails.negativeConstraint = { score: 0.22, confidence: 0.2, recentEvidence: [false, false, false, true, false], trend: 'declining' };
              prof.misconceptions.ignored_negation = { probability: 0.88, evidenceCount: 4 };
              prof.errorPatterns.ignoredNegations = 3;
              prof.behavioralLog.documentsOpened = ['safety_protocol'];
              prof.behavioralLog.ignoredEvidence = ['warning_never_exceed', 'safety_cutoff_label'];
              prof.behavioralLog.actionsAttempted = ['ACTIVATE:breaker_main', 'ACTIVATE:breaker_backup'];
              prof.behavioralLog.luckyAnswerCounts.wrong_answer_partial_understanding = 2;
              prof.experienceMemory.worldsExperienced = ['lost_observatory'];
              prof.experienceMemory.archetypesExperienced = ['RESOURCE'];
              break;
            case 'PROFILE_SURFACE_GUESSER':
              prof.skills.literalRetrieval = 0.35;
              prof.skillConfidence.literalRetrieval = 0.15;
              prof.skillDetails.literalRetrieval = { score: 0.35, confidence: 0.15, recentEvidence: [false, false, false, false, false], trend: 'declining' };
              ...
              prof.behavioralLog.documentsOpened = [];
              prof.behavioralLog.earlyCommitments = 4;
              ...
              prof.experienceMemory.worldsExperienced = ['lost_observatory'];
              prof.experienceMemory.archetypesExperienced = [];
              break;
            case 'PROFILE_STRONG_TRANSFER':
              ...
              prof.skillConfidence.sequencing = 0.80;
              prof.skillConfidence.negativeConstraint = 0.75;
              prof.skillConfidence.transfer = 0.35;
              prof.skillDetails.causeEffect = { score: 0.88, confidence: 0.85, recentEvidence: [true, true, true, true, false], trend: 'improving' };
              prof.behavioralLog.documentsOpened = ['log_alpha', 'manual_beta', 'incident_gamma', 'journal_delta'];
              prof.behavioralLog.readingOrder = ['log_alpha', 'manual_beta', 'incident_gamma', 'journal_delta'];
              prof.behavioralLog.luckyAnswerCounts.correct_answer_correct_evidence = 5;
